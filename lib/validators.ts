...
const currency = z
  ...
  .refine(
    ...
    "Price must have atleast 2 decimal places"
  );
...
export const signUpFromSchema = z
  .object({
    ...
    confirmPassword: z
      .string()
      .min(5, "Confirm password must be atleast 6 characters"),
  })
...
export const shippingAddressSchema = z.object({
  ...
  streetAddress: z.string().min(3, 'Street Address must be atleast 3 characters'),
